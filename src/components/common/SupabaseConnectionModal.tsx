...
export function SupabaseConnectionModal({ isOpen, onClose, initialTab = 'primary' }: SupabaseConnectionModalProps) {
  ...
  return typeof document !== "undefined" ? createPortal(
    ...
    >
      <div 
        className="glass-box !bg-white/95 p-5 sm:p-7 rounded-3xl max-w-xl w-full shadow-2xl border border-blue-400 relative overflow-hidden text-left max-h-[90vh] flex flex-col"
