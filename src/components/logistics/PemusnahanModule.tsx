...
export function PemusnahanModule({ onNavigateToPenyiapan }: PemusnahanModuleProps = {}) {
  ...
  return (
    <div className="space-y-2 sm:space-y-2.5 animate-fade-in text-slate-800">
      ...
      {/* ========================================================================= */}
      {/* KPI METRIC CARDS (FLEXIBLE BASED ON ACTIVE FILTERS) */}
      {/* ========================================================================= */}
      <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-2">
        {/* Total Lot */}
        <div className="p-2 sm:p-2.5 rounded-xl bg-white border border-slate-200/80 shadow-2xs flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-[10px] font-bold uppercase tracking-wider">Total Lot</span>
            <Trash2 size={13} className="text-rose-600" />
          </div>
          <div className="mt-1 flex items-baseline gap-1">
            <span className="text-base sm:text-lg font-black text-slate-800">{metrics.totalLots.toLocaleString('id-ID')}</span>
            <span className="text-[10px] text-slate-400 font-bold">Baris</span>
          </div>
        </div>

        {/* Total Qty (PCS - flexible based on filters) */}
        <div className="p-2 sm:p-2.5 rounded-xl bg-white border border-slate-200/80 shadow-2xs flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500">
          ...
          <div className="mt-1 flex items-baseline gap-1">
            <span className="text-base sm:text-lg font-black text-rose-700">{metrics.totalQtyPcs.toLocaleString('id-ID')}</span>
            <span className="text-[10px] text-rose-500 font-black">PCS</span>
          </div>
        </div>

        {/* Dari Penyiapan (Relasi) */}
        <div className="p-2 sm:p-2.5 rounded-xl bg-sky-50/70 border border-sky-200/80 shadow-2xs flex flex-col justify-between">
          <div className="flex items-center justify-between text-sky-800">
            <span className="text-[10px] font-bold uppercase tracking-wider">Dari Penyiapan</span>
            <Boxes size={13} className="text-sky-600" />
          </div>
          <div className="mt-1 flex items-baseline gap-1">
            <span className="text-base sm:text-lg font-black text-sky-900">{metrics.fromPenyiapanCount.toLocaleString('id-ID')}</span>
            <span className="text-[10px] text-sky-600 font-bold">Relasi</span>
          </div>
        </div>

        {/* Siap Dimusnahkan */}
        <div className="p-2 sm:p-2.5 rounded-xl bg-rose-50/70 border border-rose-200/80 shadow-2xs flex flex-col justify-between">
          <div className="flex items-center justify-between text-rose-800">
            <span className="text-[10px] font-bold uppercase tracking-wider">Siap Musnah</span>
            <Flame size={13} className="text-rose-600" />
          </div>
          <div className="mt-1 flex items-baseline gap-1">
            <span className="text-base sm:text-lg font-black text-rose-900">{metrics.readyDisposalCount.toLocaleString('id-ID')}</span>
            <span className="text-[10px] text-rose-600 font-bold">Item</span>
          </div>
        </div>

        {/* Selesai / Disposed / No Dok */}
        <div className="p-2 sm:p-2.5 rounded-xl bg-emerald-50/70 border border-emerald-200/80 shadow-2xs flex flex-col justify-between">
          <div className="flex items-center justify-between text-emerald-800">
            <span className="text-[10px] font-bold uppercase tracking-wider">Disposed / Dok</span>
            <CheckCircle2 size={13} className="text-emerald-600" />
          </div>
          <div className="mt-1 flex items-baseline gap-1">
            <span className="text-base sm:text-lg font-black text-emerald-900">{metrics.disposedCount.toLocaleString('id-ID')}</span>
            <span className="text-[10px] text-emerald-600 font-bold">Item</span>
          </div>
        </div>
        ...
        <div className="p-2 sm:p-2.5 rounded-xl bg-white border border-slate-200/80 shadow-2xs flex flex-col justify-between">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-[10px] font-bold uppercase tracking-wider">SKU Unik</span>
            <Barcode size={13} className="text-indigo-600" />
          </div>
          <div className="mt-1 flex items-baseline gap-1">
            <span className="text-base sm:text-lg font-black text-slate-800">{metrics.uniqueSkuCount}</span>
            <span className="text-[10px] text-slate-400 font-bold">Produk</span>
          </div>
        </div>
      </div>
