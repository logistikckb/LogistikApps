...
-- ==============================================================================
-- 8. TABEL DATA_RECO (Transaksi Rekondisi Barang / Recondition)
-- ==============================================================================
CREATE TABLE IF NOT EXISTS public.data_reco (
    id_reco VARCHAR(100) PRIMARY KEY NOT NULL,
    tujuan VARCHAR(255) DEFAULT 'Rekondisi Outer Box',
    item_code VARCHAR(100) NOT NULL,
    item_name VARCHAR(255) NOT NULL,
    category VARCHAR(100) DEFAULT 'Recondition',
    ...
    expired_date DATE,
    destination_code VARCHAR(100) DEFAULT 'RECO-LINE-1',
    qc_code VARCHAR(50) DEFAULT 'QC-HOLD',
    user_tally VARCHAR(100) DEFAULT 'Tally Reco',
    shelf_life VARCHAR(50) DEFAULT '24 Bulan',
    source VARCHAR(100) DEFAULT 'Incoming Defect Box',
    user_input VARCHAR(100) DEFAULT 'Team Reco',
    tanggal_update TIMESTAMPTZ DEFAULT TIMEZONE('utc'::text, NOW()),
